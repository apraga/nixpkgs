...
let
  ...
  ensemblGit =
    ...
    stdenv.mkDerivation {
      ...
      src = testers.invalidateFetcherByDrvHash fetchzip  {
  ...
  ensembl =
    ensemblGit "ensembl" "sha256-labyyqp+FRLIN9y4koePkX5fUls8HbCJlgYHUA0JR/0=";
  ensembl-io =
    ensemblGit "ensembl-io" "sha256-r3RvN5U2kcyghoKM0XuiBRe54t1U4FaZ0QEeYIFiG0w=";
  ensembl-variation =
    ensemblGit "ensembl-variation" "sha256-UjrLHF9EqI+Mp+SZR4sLNZUCGiA/UYhoFWtpwiKF8tM=";
  ensembl-funcgen =
    ensemblGit "ensembl-funcgen" "sha256-a9hxLBoXJsF5JWuRdpyOac1u033M8ivEjEQecuncghs=";
in
